...
@interface ViewController ()<UITableViewDelegate,UITableViewDataSource,HQAlertViewDelegate>
...
- (void)alertViewWithDelegate{
    HQAlertViewDele * alertView = [[HQAlertViewDele alloc] initWithTittle:@"提示" message:@"这个是通过delegate回调的弹窗" sureButton:@"确认按钮标题"];
...
- (void)alertViewWithBlock{
    HQAlertViewBlock * alertView = [[HQAlertViewBlock alloc] initWithTittle:@"提示" message:@"通过Block弹窗回调的弹窗" block:^(NSInteger index) {
